...
gt_one_frame_path = '/home/adib/My Git/traffic-monitoring/data/occlusion/GT_one_frame.csv'
logger.info ('Load ground truth a frame only')
with open (gt_one_frame_path, 'r') as f_buf : 
    reader = csv.DictReader (f_buf)
